...
set key at 8,0.4
set ytics 0,.1,1
plot '1Tree_wR.txt' lc 'balck' pt 8 pi -0.5 title '1-tree_w_R'  w linespoints ,'1Tree_wOR.txt' lc 'red' pt 5 pi -0.1 title '1-tree_w_oR'  w linespoints
set term pdf 
set output "1Tree_w_and_woR.pdf"
replot
set term wxt
